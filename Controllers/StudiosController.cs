...
namespace MoviePro.Models
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,FoundedDate,BoxOfficeRevenue")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,FoundedDate,BoxOfficeRevenue")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
